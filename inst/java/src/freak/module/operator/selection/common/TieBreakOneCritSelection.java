 ...
 *
 */
public class TieBreakOneCritSelection extends Selection implements Configurable, CompatibleWithDifferentSearchSpaces {
	 ...
	 */
	public TieBreakOneCritSelection(OperatorGraph graph) {
		super(graph);
		// Add ports
		super.addInPort();
		super.addOutPort();
...
//		System.out.println();
	...
	public String getName() {
		return "Tie-Breaking One Criteria Selection";
	}
	
	public String getDescription() {
		return "Selects the best individuals according to a chosen criteria of a multi value fitness function. " + "If there is a tie, criteria 0 will be used." + "Individuals coming from this generation are preferred if their " + "fitness values equal.";
	}
