...
package freak.module.mapper.cycle;
...
public class Permuter_Mapper extends AbstractMapper implements BatchEventListener {
	...
	public Permuter_Mapper(Schedule schedule) {
		...
		if (schedule.getPhenotypeSearchSpace() instanceof Cycle) {
			createPermutation();
		}
	}
	...
	public void initialize() {
		...
		int dimension = ((Cycle)schedule.getPhenotypeSearchSpace()).getDimension();
	...
	public Genotype genotypeToPhenotype(Genotype genotype) {
		Cycle searchspace = ((Cycle)schedule.getPhenotypeSearchSpace());
